...
mod tests {
    ...
    fn chinese_shell_navigation_does_not_fall_back_to_english() {
        let required = [
            ...
            "preferences.receiveCache",
            "preferences.cacheOn",
            "preferences.cacheOff",
            "preferences.cacheRetention",
            "preferences.cacheDays",
            "preferences.pruneCache",
            "preferences.pruningCache",
            "preferences.cachePruned",
            "preferences.cachePruneFailed",
